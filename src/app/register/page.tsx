      ...
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-slate-800 bg-slate-900/40 p-8 backdrop-blur-xl shadow-2xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Start tracking and reach your goals.
          </p>
        </div>
        ...
        {success && (
          <div className="flex items-center gap-2 rounded-xl bg-emerald-950/50 border border-emerald-900/50 p-4 text-sm text-emerald-400">
